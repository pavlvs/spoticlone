<div id="navBarContainer">
    <nav class="navBar">
        ...
        <div class="group">
            <div class="navItem">
                <span id="searchLink" role="link" tabindex="0" data-link="<?= BASE_URI ?>/public/index.php?action=search&term=" class="navItemLink">
        ...
        <div class="group">
            ...
            <div class="navItem">
                <span id="yourMusicLink" role="link" tabindex="0" data-link="<?= BASE_URI ?>public/index.php?action=yourmusic" class="navItemLink">Your Music</span>
            </div>
            <div class="navItem">
